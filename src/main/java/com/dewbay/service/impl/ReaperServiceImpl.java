...
import com.dewbay.service.LoginService;
import com.dewbay.service.OrderService;
import com.dewbay.service.ReaperService;
import com.dewbay.service.StationService;
import com.dewbay.util.DingRobotUtils;
import com.dewbay.util.HttpClientUtils;
import com.dewbay.util.JsonUtils;
...
public class ReaperServiceImpl implements ReaperService {
    ...
    public void monitor() {
        try {
            ...
            for (JsonNode infoNode : trainNodes) {
                ...
                //构建订单
                JsonNode orderNode = buildOrder(accessToken, JsonUtils.getJsonPassengers(passengers), contactMobile, contactName, infoNode);
                if (orderNode == null) {
                    continue;
                }
    ...
    private JsonNode buildOrder(String accessToken, String passengerList, String contactMobile, String contactName, JsonNode infoNode) {
        String orderJson = orderService.buildOrder(accessToken, passengerList, contactMobile, contactName, infoNode);
    ...
    public JsonNode getTrainInfosNode(String fromStation, String toStation, String deptDate, String justGD, Map<String, String> headers, String webhookToken) throws IOException {
